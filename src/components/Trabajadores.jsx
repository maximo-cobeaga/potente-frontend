...
export function Trabajadores({ propiedad }) {
    const { titulo_propiedad } = propiedad
    const { ficha } = propiedad
    return (
        <div className="contacto">
            <p className="titulo">Oficina: Av. de los Trabajadores 2439</p>
            <ul>
                <li><img src={email} alt="" />potentemogotes@pimas.com.ar</li>
                <li><img src={phone} alt="" />2234840619 | 2235851198</li>
            </ul>
            <a target='_blank' className='button-link' href={`https://api.whatsapp.com/send?phone=2234840619&text=%C2%A1Hola!%20quiero%20informacion%20sobre%20la%20propiedad%3A%20${titulo_propiedad !== undefined && titulo_propiedad.replaceAll(' ', '%20')}.%20(Id%3A%20${ficha !== undefined && ficha})`}>
