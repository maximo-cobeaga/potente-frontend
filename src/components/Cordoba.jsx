...
export function Cordoba({ propiedad }) {
    ...
    return (
        <div className="contacto">
            <p className="titulo">Oficina: Cordoba 3719</p>
            <ul>
                <li><img src={email} alt="" />info@potenteprop.com.ar</li>
                <li><img src={phone} alt="" />2234727416 | 2235129032</li>
            </ul>
            <a target='_blank' className='button-link' href={`https://api.whatsapp.com/send?phone=2234727416&text=%C2%A1Hola!%20quiero%20informacion%20sobre%20la%20propiedad%3A%20${titulo_propiedad !== undefined && titulo_propiedad.replaceAll(' ', '%20')}.%20(Id%3A%20${ficha !== undefined && ficha})`}>
